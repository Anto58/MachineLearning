...
Since there are still a relatively large number of predictor variables and I was not expert in the nature of these predictors, I used a correlation matrix to remove redundant variables.  As before, the same process must be applied to the testing dataset.
